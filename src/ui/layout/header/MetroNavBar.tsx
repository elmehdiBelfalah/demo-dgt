      ...
      <div id="kt_header" className="header bg-white align-items-stretch">
        <div className="container-fluid d-flex align-items-stretch justify-content-between">
          ...
          <div className="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a className="d-lg-none" href="/metronic8/react/demo4/dashboard">
              <img
                alt="Logo"
                src="/metronic8/react/demo4/media/logos/logo-demo4-mobile.svg"
                className="h-30px"
              />
            </a>
          </div>
          ...
          <div className="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
            ...
            <div className="d-flex align-items-stretch justify-self-end flex-shrink-0">
                        ...
                        <div className="scroll-y mh-200px mh-lg-350px">
                          ...
                          >
                            <div className="symbol symbol-40px me-4">
                              <img
                                src="/metronic8/react/demo4/media/avatars/300-6.jpg"
                                alt=""
                              />
                            </div>
                          ...
                          >
                            <div className="symbol symbol-40px me-4">
                              <img
                                src="/metronic8/react/demo4/media/avatars/300-2.jpg"
                                alt=""
                              />
                            </div>
                            <div className="d-flex flex-column justify-content-start fw-bold">
                          ...
                          >
                            <div className="symbol symbol-40px me-4">
                              <img
                                src="/metronic8/react/demo4/media/avatars/300-9.jpg"
                                alt=""
                              />
                            </div>
                            <div className="d-flex flex-column justify-content-start fw-bold">
                          ...
                          >
                            <div className="symbol symbol-40px me-4">
                              <img
                                src="/metronic8/react/demo4/media/avatars/300-14.jpg"
                                alt=""
                              />
                            </div>
                            <div className="d-flex flex-column justify-content-start fw-bold">
                          ...
                          >
                            <div className="symbol symbol-40px me-4">
                              <img
                                src="/metronic8/react/demo4/media/avatars/300-11.jpg"
                                alt=""
                              />
                            </div>
                            <div className="d-flex flex-column justify-content-start fw-bold">
                            ...
                            <div className="symbol symbol-40px me-4">
                              <span className="symbol-label bg-light">
                                <img
                                  ...
                                  src="/metronic8/react/demo4/media/svg/brand-logos/volicity-9.svg"
                                  alt=""
                                />
                              </span>
                            </div>
                          ...
                          >
                            <div className="symbol symbol-40px me-4">
                              <span className="symbol-label bg-light">
                                <img
                                  className="w-20px h-20px"
                                  src="/metronic8/react/demo4/media/svg/brand-logos/tvit.svg"
                                  alt=""
                                />
                              </span>
                            </div>
                          ...
                          >
                            <div className="symbol symbol-40px me-4">
                              <span className="symbol-label bg-light">
                                <img
                                  className="w-20px h-20px"
                                  src="/metronic8/react/demo4/media/svg/misc/infography.svg"
                                  alt=""
                                />
                              </span>
                            </div>
                          ...
                          >
                            <div className="symbol symbol-40px me-4">
                              <span className="symbol-label bg-light">
                                <img
                                  className="w-20px h-20px"
                                  src="/metronic8/react/demo4/media/svg/brand-logos/leaf.svg"
                                  alt=""
                                />
                              </span>
                            </div>
                          ...
                          >
                            <div className="symbol symbol-40px me-4">
                              <span className="symbol-label bg-light">
                                <img
                                  className="w-20px h-20px"
                                  src="/metronic8/react/demo4/media/svg/brand-logos/tower.svg"
                                  alt=""
                                />
                              </span>
                            </div>
              ...
              <div className="d-flex align-items-center ms-1 ms-lg-3">
                <div
                  className="btn btn-icon btn-active-light-primary btn-custom btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px"
                    ...
                    >
                      ...
                      <div className="py-3 text-center border-top">
                        <a
                          ...
                          href="/metronic8/react/demo4/crafted/pages/profile"
                        >
                          View All{" "}
                      ...
                      <div className="d-flex flex-column px-9">
                        ...
                        <div className="text-center px-4">
                          <img
                            ...
                            alt="metronic"
                            src="/metronic8/react/demo4/media/illustrations/dozzy-1/1.png"
                          />
                        </div>
                      </div>
                    </div>
              ...
              <div className="d-flex align-items-center ms-1 ms-lg-3">
                <div
                  className="btn btn-icon btn-active-light-primary btn-custom position-relative btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px"
              ...
              >
                ...
                >
                  <img
                    src="/metronic8/react/demo4/media/avatars/300-1.jpg"
                    alt="metronic"
                  />
                </div>
                <div
                      ...
                      <span className="menu-title position-relative">
                        ...
                        <span className="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">
                          ...
                          <img
                            ...
                            src="/metronic8/react/demo4/media/flags/united-states.svg"
                            alt="metronic"
                          />
                        </span>
                      </span>
                      ...
                      <div className="menu-item px-3">
                        <a href="#" className="menu-link d-flex px-5">
                          <span className="symbol symbol-20px me-4">
                            <img
                              className="rounded-1"
                              src="/metronic8/react/demo4/media/flags/china.svg"
                              alt="metronic"
                            />
                          </span>
                          Mandarin
                      ...
                      <div className="menu-item px-3">
                        <a href="#" className="menu-link d-flex px-5">
                          <span className="symbol symbol-20px me-4">
                            <img
                              className="rounded-1"
                              src="/metronic8/react/demo4/media/flags/spain.svg"
                              alt="metronic"
                            />
                          </span>
                          Spanish
                      ...
                      <div className="menu-item px-3">
                        <a href="#" className="menu-link d-flex px-5">
                          <span className="symbol symbol-20px me-4">
                            <img
                              className="rounded-1"
                              src="/metronic8/react/demo4/media/flags/japan.svg"
                              alt="metronic"
                            />
                          </span>
                          Japanese
                      ...
                      <div className="menu-item px-3">
                        <a href="#" className="menu-link d-flex px-5">
                          <span className="symbol symbol-20px me-4">
                            <img
                              className="rounded-1"
                              src="/metronic8/react/demo4/media/flags/germany.svg"
                              alt="metronic"
                            />
                          </span>
                          German
                      ...
                      <div className="menu-item px-3">
                        <a href="#" className="menu-link d-flex px-5">
                          <span className="symbol symbol-20px me-4">
                            <img
                              className="rounded-1"
                              src="/metronic8/react/demo4/media/flags/france.svg"
                              alt="metronic"
                            />
                          </span>
                          French
